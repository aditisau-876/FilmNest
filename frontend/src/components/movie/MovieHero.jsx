      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-8 flex items-end pb-20">
        ...
        >
          ...
          <div className="max-w-3xl">
            ...
            {movie.tagline && (
              <p className="italic text-gray-400 text-xl mt-3">
                {movie.tagline}
              </p>
            )}
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <span className="bg-red-600/20 border border-red-600 text-red-400 px-4 py-2 rounded-full">
            ...
            {/* Overview */}
            <p className="max-w-2xl mt-8 text-gray-300 leading-8 text-lg">
              {movie.overview}
            </p>
