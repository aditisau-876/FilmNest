  ...
  return (
    <section className="max-w-7xl mx-auto px-8 py-14">
      ...
      <div className="flex gap-8 overflow-x-auto scrollbar-hide">
        {cast.map((actor) => (
          <div key={actor.id} className="min-w-[180px] text-center">
            <img src={actor.profile_url} alt={actor.name} className="w-40 h-40 rounded-full object-cover mx-auto border border-white/10"/>
