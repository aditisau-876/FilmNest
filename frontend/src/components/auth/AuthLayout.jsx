  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <motion.div
        ...
        className="absolute top-0 left-0 w-[500px] h-[500px] rounded-full bg-red-600/20 blur-[180px]"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-0 right-0 w-[450px] h-[450px] rounded-full bg-red-700/20 blur-[180px]"
      />
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center px-6">
        ...
        <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 bg-red-600/20 px-5 py-2 rounded-full border border-red-500/30 mb-8">
            ...
            <p className="mt-8 text-gray-300 text-lg leading-8 max-w-xl">
              ...
              ratings, reviews, streaming platforms and
          ...
          >
            ...
            <div
              ...
              border
              border-white/10
              shadow-[0_0_45px_rgba(229,9,20,.25)]
              p-10
              "
            >
